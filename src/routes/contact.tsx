  ...
  head: () => ({
    meta: [
      { title: "Contact Us — Bizwise Consultants | Karachi, Pakistan" },
      {
        name: "description",
        content:
          "Get in touch with Bizwise Consultants in Karachi. WhatsApp +92 317 2138835 for a free consultation.",
      },
        ...
        <div className="container-page grid lg:grid-cols-2 gap-12">
          <div className="space-y-5 animate-fade-up">
            {[
              ...
              <div
                key={c.title}
                className="flex items-start gap-4 bg-card rounded-2xl p-6 shadow-soft hover-lift"
              >
            ...
            <div className="mt-8 grid sm:grid-cols-2 gap-5">
              ...
              <div className="sm:col-span-2">
                ...
                <textarea
                  required
                  rows={5}
                  className="w-full rounded-md border border-input bg-background px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-brand"
                />
              </div>
              <button
                type="submit"
                className="sm:col-span-2 inline-flex items-center justify-center gap-2 rounded-md bg-brand px-6 py-4 font-bold text-brand-foreground shadow-brand transition-smooth hover:scale-[1.02]"
              >
