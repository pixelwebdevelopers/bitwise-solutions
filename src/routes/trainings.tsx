  ...
  head: () => ({
    meta: [
      { title: "Trainings & Learning — Accounting, Tax & Tools | Bizwise Consultants" },
      {
        name: "description",
        content:
          "Professional trainings in Accounting, Taxation, Auditing and tools like QuickBooks, Tally, Excel & Power BI. Learning support for ACCA, ICAP, ICMAP and PIPFA students.",
      },
      { property: "og:title", content: "Trainings — Bizwise Consultants" },
      {
        property: "og:description",
        content: "Skill-building for finance professionals and students.",
      },
    ],
  }),
      ...
      <section className="relative gradient-hero text-primary-foreground py-20 md:py-28 overflow-hidden">
        ...
        <div className="container-page relative text-center animate-fade-up">
          ...
          <h1 className="mt-3 text-4xl md:text-6xl font-extrabold">
            Build skills that pay dividends
          </h1>
          <p className="mt-5 max-w-2xl mx-auto text-primary-foreground/85 text-lg">
            Practical training for working professionals and structured learning for accountancy
            students.
          </p>
        </div>
      </section>
        ...
        <div className="container-page grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-fade-up">
            ...
            <p className="mt-4 text-muted-foreground">
              Hands-on, role-relevant training delivered by practicing experts.
            </p>
            <div className="mt-6 grid sm:grid-cols-2 gap-3">
              {[
                ...
                <div
                  key={t}
                  className="flex items-center gap-2 rounded-lg bg-secondary/60 px-4 py-3"
                >
      ...
      <section className="py-24 bg-secondary/40">
        <div className="container-page">
          <SectionHeading
            ...
            subtitle="Mentoring and resources for ACCA, ICAP, ICMAP and PIPFA aspirants."
          />
            ...
            {[
              {
                ...
                desc: "Topic-by-topic coaching aligned with each body's syllabus.",
              },
              {
                icon: Video,
                title: "Video Tutorials",
                desc: "On-demand lessons covering core concepts and case studies.",
              },
              {
                icon: Award,
                title: "Exam Preparation",
                desc: "Mock exams, past paper drills and time-management strategies.",
              },
            ].map((c, i) => (
              <div
                key={c.title}
          ...
          <div className="mt-14 text-center animate-fade-up">
            <Link
              to="/contact"
              className="inline-flex items-center gap-2 rounded-md bg-brand px-7 py-3.5 font-bold text-brand-foreground shadow-brand transition-smooth hover:scale-105"
            >
